...
if __name__ == "__main__":
    ...
    DICTS_TO_COMBINE = create_sub_files_list(SUPP_INFO_DIRECTORY, project_config.SCRAPE_TITLE, 1, 8)
    ...
    test_list = [
        ...
        SUPP_INFO_DIRECTORY + f"{project_config.SCRAPE_TITLE}_candidate_supplemental_info8.json"
    ]
